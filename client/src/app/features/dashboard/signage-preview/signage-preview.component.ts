  ...
  template: `
    <div class="bg-slate-900/60 border border-slate-800 rounded-xl p-5 backdrop-blur shadow-lg">
      ...
      @if (store.latestResult(); as result) {
        <div class="bg-black border-2 border-cyan-500/40 rounded-lg p-4 mb-3 shadow-[0_0_20px_rgba(6,182,212,0.15)]" role="status" aria-live="polite">
          <div class="text-red-400 text-xs font-bold mb-2"><span aria-hidden="true">⚠️</span> {{ store.severity() || 'ALERT' }}</div>
